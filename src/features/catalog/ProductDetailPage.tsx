...
const MOCK_REVIEWS = [
  {
    ...
    verified: true,
    rating: 5,
    text: 'Excellent produit ! La qualite est au rendez-vous et la livraison a ete rapide. Je suis tres satisfait de mon achat chez QG Batimat.',
    date: '14 Aout 2024',
  },
  {
    name: 'Alex M.',
    verified: true,
    rating: 5,
    text: 'Le produit a depasse mes attentes. La qualite est irrepro chable et le rapport qualite-prix est excellent. Je recommande vivement.',
    date: '15 Aout 2024',
  },
  {
    name: 'Ethan R.',
    verified: true,
    rating: 4,
    text: 'Tres bon produit pour le chantier. Solide et facile a utiliser. Le design est pratique et bien pense pour une utilisation professionnelle.',
    date: '16 Aout 2024',
  },
  {
    name: 'Olivia P.',
    verified: true,
    rating: 4,
    text: "Bonne qualite generale. Le produit correspond bien a la description. La livraison a ete rapide et l'emballage etait soigne.",
    date: '17 Aout 2024',
  },
  {
    name: 'Liam K.',
    verified: true,
    rating: 5,
    text: "Parfait pour mon projet de renovation. Tres bonne finition et materiau de qualite. Je n'hesiterai pas a recommander QG Batimat.",
    date: '18 Aout 2024',
  },
  {
    name: 'Ava H.',
    verified: true,
    rating: 4,
    text: 'Produit conforme a mes attentes. La solidite est au rendez-vous et la prise en main est facile. Bon choix pour les professionnels.',
    date: '19 Aout 2024',
  },
]
                    ...
                    <div key={review.name} className="border border-zinc-200 rounded-2xl p-5">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <button
                          ...
                          aria-label="Plus d'options pour cet avis"
                        >
                          <svg
                            className="w-5 h-5"
                            fill="currentColor"
